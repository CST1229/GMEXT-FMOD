// https://github.com/tadashibashi/fmod-studio-typescript-types/blob/master/index.d.ts
// modified to add more stuff and make it work with jsdoc

// regexes:
// [constant strings].replaceAll(/(\w+): (\w+);/gi, (cap, g1, g2) => {return `${g1}: ${g2} = ${FMOD[g1]};`})
// enumify: \b((DSP_STFF)_(\w+)): number = .+;
// $1: FMOD.$2 = FMOD.$2.$3;
...
declare interface FMOD {
    ...
    // stuff typescript spat out when i did "Add all missing members" with the missing members

	ready: Promise<this>;
	preloadedImages: {};
	preloadedAudios: {};
	FS_createPath: (parent: any, path: any, canRead: any, canWrite: any) => void;
	FS_createDataFile: (parent: any, name: any, data: any, canRead: any, canWrite: any, canOwn: any) => void;
	FS_createLazyFile: (parent: any, name: any, url: any, canRead: any, canWrite: any) => void;
	FS_createDevice: (parent: any, name: any, input: any, output: any) => void;
	FS_unlink: (path: any) => void;
	BindingError: () => void;
	InternalError: () => void;
	...
	UnboundTypeError: () => void;
	count_emval_handles: () => void;
	get_first_emval: () => void;
	requestFullscreen: (lockPointer: any, resizeCanvas: any) => void;
	requestAnimationFrame: (func: any) => void;
	setCanvasSize: (width: any, height: any, noUpdates: any) => void;
	pauseMainLoop: () => void;
	resumeMainLoop: () => void;
	getUserMedia: () => void;
	createContext: (canvas: any, useWebGL: any, setInModule: any, webGLContextAttributes: any) => void;
	___wasm_call_ctors: () => void;
	_strlen: () => void;
	_malloc: () => void;
	_free: () => void;
	___errno_location: () => void;
	_FMOD_JS_MixFunction: () => void;
	_FMOD_JS_MixerSlowpathFunction: () => void;
	_FMOD_JS_MixerFastpathFunction: () => void;
	___getTypeName: () => void;
	___embind_register_native_and_builtin_types: () => void;
	stackSave: () => void;
	stackRestore: () => void;
	stackAlloc: () => void;
	dynCall_iiiii: () => void;
	...
	dynCall_iif: () => void;
	dynCall_fiii: () => void;
	dynCall_iiiiiii: () => void;
	dynCall_iiji: () => void;
	dynCall_fi: () => void;
	dynCall_iij: () => void;
	dynCall_iiiff: () => void;
	dynCall_ji: () => void;
	dynCall_iijjifi: () => void;
	dynCall_iijjifii: () => void;
	dynCall_iijj: () => void;
	dynCall_iiiiiiii: () => void;
	dynCall_iiff: () => void;
	dynCall_iifi: () => void;
	dynCall_iiffffffff: () => void;
	dynCall_iijji: () => void;
	dynCall_iijf: () => void;
	dynCall_iifff: () => void;
	dynCall_iiffi: () => void;
	dynCall_iiiiiiiiii: () => void;
	dynCall_viiiiii: () => void;
	dynCall_viii: () => void;
	dynCall_iiiffi: () => void;
	dynCall_iiifffii: () => void;
	dynCall_iiiifffffiii: () => void;
	dynCall_iiiffffii: () => void;
	dynCall_iiifffffii: () => void;
	dynCall_iiifffi: () => void;
	dynCall_viiii: () => void;
	dynCall_viiiiiiffffff: () => void;
	dynCall_viiiiiii: () => void;
	dynCall_viiiiif: () => void;
	dynCall_iiiiffi: () => void;
	dynCall_iiiiiiiiiiiii: () => void;
	dynCall_iiiiiffi: () => void;
	dynCall_viiiiiiiifffii: () => void;
	dynCall_fif: () => void;
	dynCall_viiiii: () => void;
	dynCall_viiiiiiiiifff: () => void;
	dynCall_iiiiiiiiiiii: () => void;
	dynCall_iiiiiiiii: () => void;
	dynCall_iiidii: () => void;
	dynCall_iiifff: () => void;
	dynCall_iiiidii: () => void;
	dynCall_iiifi: () => void;
	dynCall_iiiif: () => void;
	dynCall_iiddi: () => void;
	dynCall_iidf: () => void;
	dynCall_iidd: () => void;
	dynCall_iiiffffffff: () => void;
	dynCall_iiiddi: () => void;
	dynCall_iiidf: () => void;
	dynCall_iiidd: () => void;
	dynCall_iiiiff: () => void;
	dynCall_iiiifi: () => void;
	dynCall_jiji: () => void;
	dynCall_iidiiii: () => void;
	_asyncify_start_unwind: () => void;
	_asyncify_stop_unwind: () => void;
	_asyncify_start_rewind: () => void;
	_asyncify_stop_rewind: () => void;
	cwrap: (ident: any, returnType: any, argTypes: any, opts: any) => void;
	...
	Reverb3D: () => void;
	CPU_USAGE: () => void;
	DSP_PARAMETER_ATTENUATION_RANGE: () => void;
	studioSystem: () => void;
	...
	Bank: () => void;
	CommandReplay: () => void;	
	OUTPUT_METHOD_MIX_DIRECT: number;
	OUTPUT_METHOD_MIX_BUFFERED: number;
	OK: FMOD.RESULT;
	ERR_BADCOMMAND: FMOD.RESULT;
	ERR_CHANNEL_ALLOC: FMOD.RESULT;
	ERR_CHANNEL_STOLEN: FMOD.RESULT;
	ERR_DMA: FMOD.RESULT;
	ERR_DSP_CONNECTION: FMOD.RESULT;
	ERR_DSP_DONTPROCESS: FMOD.RESULT;
	ERR_DSP_FORMAT: FMOD.RESULT;
	ERR_DSP_INUSE: FMOD.RESULT;
	ERR_DSP_NOTFOUND: FMOD.RESULT;
	ERR_DSP_RESERVED: FMOD.RESULT;
	ERR_DSP_SILENCE: FMOD.RESULT;
	ERR_DSP_TYPE: FMOD.RESULT;
	ERR_FILE_BAD: FMOD.RESULT;
	ERR_FILE_COULDNOTSEEK: FMOD.RESULT;
	ERR_FILE_DISKEJECTED: FMOD.RESULT;
	ERR_FILE_EOF: FMOD.RESULT;
	ERR_FILE_ENDOFDATA: FMOD.RESULT;
	ERR_FILE_NOTFOUND: FMOD.RESULT;
	ERR_FORMAT: FMOD.RESULT;
	ERR_HEADER_MISMATCH: FMOD.RESULT;
	ERR_HTTP: FMOD.RESULT;
	ERR_HTTP_ACCESS: FMOD.RESULT;
	ERR_HTTP_PROXY_AUTH: FMOD.RESULT;
	ERR_HTTP_SERVER_ERROR: FMOD.RESULT;
	ERR_HTTP_TIMEOUT: FMOD.RESULT;
	ERR_INITIALIZATION: FMOD.RESULT;
	ERR_INITIALIZED: FMOD.RESULT;
	ERR_INTERNAL: FMOD.RESULT;
	ERR_INVALID_FLOAT: FMOD.RESULT;
	ERR_INVALID_HANDLE: FMOD.RESULT;
	ERR_INVALID_PARAM: FMOD.RESULT;
	ERR_INVALID_POSITION: FMOD.RESULT;
	ERR_INVALID_SPEAKER: FMOD.RESULT;
	ERR_INVALID_SYNCPOINT: FMOD.RESULT;
	ERR_INVALID_THREAD: FMOD.RESULT;
	ERR_INVALID_VECTOR: FMOD.RESULT;
	ERR_MAXAUDIBLE: FMOD.RESULT;
	ERR_MEMORY: FMOD.RESULT;
	ERR_MEMORY_CANTPOINT: FMOD.RESULT;
	ERR_NEEDS3D: FMOD.RESULT;
	ERR_NEEDSHARDWARE: FMOD.RESULT;
	ERR_NET_CONNECT: FMOD.RESULT;
	ERR_NET_SOCKET_ERROR: FMOD.RESULT;
	ERR_NET_URL: FMOD.RESULT;
	ERR_NET_WOULD_BLOCK: FMOD.RESULT;
	ERR_NOTREADY: FMOD.RESULT;
	ERR_OUTPUT_ALLOCATED: FMOD.RESULT;
	ERR_OUTPUT_CREATEBUFFER: FMOD.RESULT;
	ERR_OUTPUT_DRIVERCALL: FMOD.RESULT;
	ERR_OUTPUT_FORMAT: FMOD.RESULT;
	ERR_OUTPUT_INIT: FMOD.RESULT;
	ERR_OUTPUT_NODRIVERS: FMOD.RESULT;
	ERR_PLUGIN: FMOD.RESULT;
	ERR_PLUGIN_MISSING: FMOD.RESULT;
	ERR_PLUGIN_RESOURCE: FMOD.RESULT;
	ERR_PLUGIN_VERSION: FMOD.RESULT;
	ERR_RECORD: FMOD.RESULT;
	ERR_REVERB_CHANNELGROUP: FMOD.RESULT;
	ERR_REVERB_INSTANCE: FMOD.RESULT;
	ERR_SUBSOUNDS: FMOD.RESULT;
	ERR_SUBSOUND_ALLOCATED: FMOD.RESULT;
	ERR_SUBSOUND_CANTMOVE: FMOD.RESULT;
	ERR_TAGNOTFOUND: FMOD.RESULT;
	ERR_TOOMANYCHANNELS: FMOD.RESULT;
	ERR_TRUNCATED: FMOD.RESULT;
	ERR_UNIMPLEMENTED: FMOD.RESULT;
	ERR_UNINITIALIZED: FMOD.RESULT;
	ERR_UNSUPPORTED: FMOD.RESULT;
	ERR_VERSION: FMOD.RESULT;
	ERR_EVENT_ALREADY_LOADED: FMOD.RESULT;
	ERR_EVENT_LIVEUPDATE_BUSY: FMOD.RESULT;
	ERR_EVENT_LIVEUPDATE_MISMATCH: FMOD.RESULT;
	ERR_EVENT_LIVEUPDATE_TIMEOUT: FMOD.RESULT;
	ERR_EVENT_NOTFOUND: FMOD.RESULT;
	ERR_STUDIO_UNINITIALIZED: FMOD.RESULT;
	ERR_STUDIO_NOT_LOADED: FMOD.RESULT;
	ERR_INVALID_STRING: FMOD.RESULT;
	ERR_ALREADY_LOCKED: FMOD.RESULT;
	ERR_NOT_LOCKED: FMOD.RESULT;
	ERR_RECORD_DISCONNECTED: FMOD.RESULT;
	ERR_TOOMANYSAMPLES: FMOD.RESULT;
	CHANNELCONTROL_CHANNEL: FMOD.CHANNELCONTROL_TYPE;
	CHANNELCONTROL_CHANNELGROUP: FMOD.CHANNELCONTROL_TYPE;
	CHANNELCONTROL_MAX: FMOD.CHANNELCONTROL_TYPE;
	OUTPUTTYPE_AUTODETECT: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_UNKNOWN: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_NOSOUND: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_WAVWRITER: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_NOSOUND_NRT: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_WAVWRITER_NRT: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_WASAPI: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_ASIO: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_PULSEAUDIO: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_ALSA: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_COREAUDIO: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_AUDIOTRACK: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_OPENSL: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_AUDIOOUT: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_AUDIO3D: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_WEBAUDIO: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_NNAUDIO: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_WINSONIC: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_AAUDIO: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_AUDIOWORKLET: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_PHASE: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_OHAUDIO: FMOD.OUTPUTTYPE;
	OUTPUTTYPE_MAX: FMOD.OUTPUTTYPE;
	DEBUG_MODE_TTY: FMOD.DEBUG_MODE;
	DEBUG_MODE_FILE: FMOD.DEBUG_MODE;
	DEBUG_MODE_CALLBACK: FMOD.DEBUG_MODE;
	SPEAKERMODE_DEFAULT: FMOD.SPEAKERMODE;
	SPEAKERMODE_RAW: FMOD.SPEAKERMODE;
	SPEAKERMODE_MONO: FMOD.SPEAKERMODE;
	SPEAKERMODE_STEREO: FMOD.SPEAKERMODE;
	SPEAKERMODE_QUAD: FMOD.SPEAKERMODE;
	SPEAKERMODE_SURROUND: FMOD.SPEAKERMODE;
	SPEAKERMODE_5POINT1: FMOD.SPEAKERMODE;
	SPEAKERMODE_7POINT1: FMOD.SPEAKERMODE;
	SPEAKERMODE_7POINT1POINT4: FMOD.SPEAKERMODE;
	SPEAKERMODE_MAX: FMOD.SPEAKERMODE;
	SPEAKER_NONE: FMOD.SPEAKER;
	SPEAKER_FRONT_LEFT: FMOD.SPEAKER;
	SPEAKER_FRONT_RIGHT: FMOD.SPEAKER;
	SPEAKER_FRONT_CENTER: FMOD.SPEAKER;
	SPEAKER_LOW_FREQUENCY: FMOD.SPEAKER;
	SPEAKER_SURROUND_LEFT: FMOD.SPEAKER;
	SPEAKER_SURROUND_RIGHT: FMOD.SPEAKER;
	SPEAKER_BACK_LEFT: FMOD.SPEAKER;
	SPEAKER_TOP_FRONT_LEFT: FMOD.SPEAKER;
	SPEAKER_TOP_FRONT_RIGHT: FMOD.SPEAKER;
	SPEAKER_TOP_BACK_LEFT: FMOD.SPEAKER;
	SPEAKER_TOP_BACK_RIGHT: FMOD.SPEAKER;
	SPEAKER_MAX: FMOD.SPEAKER;
	CHANNELORDER_DEFAULT: FMOD.CHANNELORDER;
	CHANNELORDER_WAVEFORMAT: FMOD.CHANNELORDER;
	CHANNELORDER_PROTOOLS: FMOD.CHANNELORDER;
	CHANNELORDER_ALLMONO: FMOD.CHANNELORDER;
	CHANNELORDER_ALLSTEREO: FMOD.CHANNELORDER;
	CHANNELORDER_ALSA: FMOD.CHANNELORDER;
	CHANNELORDER_MAX: FMOD.CHANNELORDER;
	PLUGINTYPE_OUTPUT: FMOD.PLUGINTYPE;
	PLUGINTYPE_CODEC: FMOD.PLUGINTYPE;
	PLUGINTYPE_DSP: FMOD.PLUGINTYPE;
	PLUGINTYPE_MAX: FMOD.PLUGINTYPE;
	SOUND_TYPE_UNKNOWN: FMOD.SOUND_TYPE;
	SOUND_TYPE_AIFF: FMOD.SOUND_TYPE;
	SOUND_TYPE_ASF: FMOD.SOUND_TYPE;
	SOUND_TYPE_DLS: FMOD.SOUND_TYPE;
	SOUND_TYPE_FLAC: FMOD.SOUND_TYPE;
	SOUND_TYPE_FSB: FMOD.SOUND_TYPE;
	SOUND_TYPE_IT: FMOD.SOUND_TYPE;
	SOUND_TYPE_MIDI: FMOD.SOUND_TYPE;
	SOUND_TYPE_MOD: FMOD.SOUND_TYPE;
	SOUND_TYPE_MPEG: FMOD.SOUND_TYPE;
	SOUND_TYPE_OGGVORBIS: FMOD.SOUND_TYPE;
	SOUND_TYPE_PLAYLIST: FMOD.SOUND_TYPE;
	SOUND_TYPE_RAW: FMOD.SOUND_TYPE;
	SOUND_TYPE_S3M: FMOD.SOUND_TYPE;
	SOUND_TYPE_USER: FMOD.SOUND_TYPE;
	SOUND_TYPE_WAV: FMOD.SOUND_TYPE;
	SOUND_TYPE_XM: FMOD.SOUND_TYPE;
	SOUND_TYPE_XMA: FMOD.SOUND_TYPE;
	SOUND_TYPE_AUDIOQUEUE: FMOD.SOUND_TYPE;
	SOUND_TYPE_AT9: FMOD.SOUND_TYPE;
	SOUND_TYPE_VORBIS: FMOD.SOUND_TYPE;
	SOUND_TYPE_MEDIA_FOUNDATION: FMOD.SOUND_TYPE;
	SOUND_TYPE_MEDIACODEC: FMOD.SOUND_TYPE;
	SOUND_TYPE_FADPCM: FMOD.SOUND_TYPE;
	SOUND_TYPE_OPUS: FMOD.SOUND_TYPE;
	SOUND_TYPE_MAX: FMOD.SOUND_TYPE;
	SOUND_FORMAT_NONE: FMOD.SOUND_FORMAT;
	SOUND_FORMAT_PCM8: FMOD.SOUND_FORMAT;
	SOUND_FORMAT_PCM16: FMOD.SOUND_FORMAT;
	SOUND_FORMAT_PCM24: FMOD.SOUND_FORMAT;
	SOUND_FORMAT_PCM32: FMOD.SOUND_FORMAT;
	SOUND_FORMAT_PCMFLOAT: FMOD.SOUND_FORMAT;
	SOUND_FORMAT_BITSTREAM: FMOD.SOUND_FORMAT;
	SOUND_FORMAT_MAX: FMOD.SOUND_FORMAT;
	OPENSTATE_READY: FMOD.OPENSTATE;
	OPENSTATE_LOADING: FMOD.OPENSTATE;
	OPENSTATE_ERROR: FMOD.OPENSTATE;
	OPENSTATE_CONNECTING: FMOD.OPENSTATE;
	OPENSTATE_BUFFERING: FMOD.OPENSTATE;
	OPENSTATE_SEEKING: FMOD.OPENSTATE;
	OPENSTATE_PLAYING: FMOD.OPENSTATE;
	OPENSTATE_SETPOSITION: FMOD.OPENSTATE;
	OPENSTATE_MAX: FMOD.OPENSTATE;
	SOUNDGROUP_BEHAVIOR_FAIL: FMOD.SOUNDGROUP_BEHAVIOR;
	SOUNDGROUP_BEHAVIOR_MUTE: FMOD.SOUNDGROUP_BEHAVIOR;
	SOUNDGROUP_BEHAVIOR_STEALLOWEST: FMOD.SOUNDGROUP_BEHAVIOR;
	SOUNDGROUP_BEHAVIOR_MAX: FMOD.SOUNDGROUP_BEHAVIOR;
	CHANNELCONTROL_CALLBACK_END: FMOD.CHANNELCONTROL_CALLBACK_TYPE;
	CHANNELCONTROL_CALLBACK_VIRTUALVOICE: FMOD.CHANNELCONTROL_CALLBACK_TYPE;
	CHANNELCONTROL_CALLBACK_SYNCPOINT: FMOD.CHANNELCONTROL_CALLBACK_TYPE;
	CHANNELCONTROL_CALLBACK_OCCLUSION: FMOD.CHANNELCONTROL_CALLBACK_TYPE;
	CHANNELCONTROL_CALLBACK_MAX: FMOD.CHANNELCONTROL_CALLBACK_TYPE;
	CHANNELCONTROL_DSP_HEAD: FMOD.CHANNELCONTROL_DSP_INDEX;
	CHANNELCONTROL_DSP_FADER: FMOD.CHANNELCONTROL_DSP_INDEX;
	CHANNELCONTROL_DSP_TAIL: FMOD.CHANNELCONTROL_DSP_INDEX;
	ERRORCALLBACK_INSTANCETYPE_NONE: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_SYSTEM: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_CHANNEL: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_CHANNELGROUP: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_CHANNELCONTROL: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_SOUND: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_SOUNDGROUP: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_DSP: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_DSPCONNECTION: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_GEOMETRY: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_REVERB3D: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_STUDIO_SYSTEM: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_STUDIO_EVENTDESCRIPTION: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_STUDIO_EVENTINSTANCE: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_STUDIO_PARAMETERINSTANCE: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_STUDIO_BUS: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_STUDIO_VCA: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_STUDIO_BANK: FMOD.ERRORCALLBACK_INSTANCETYPE;
	ERRORCALLBACK_INSTANCETYPE_STUDIO_COMMANDREPLAY: FMOD.ERRORCALLBACK_INSTANCETYPE;
	DSP_RESAMPLER_DEFAULT: FMOD.DSP_RESAMPLER;
	DSP_RESAMPLER_NOINTERP: FMOD.DSP_RESAMPLER;
	DSP_RESAMPLER_LINEAR: FMOD.DSP_RESAMPLER;
	DSP_RESAMPLER_CUBIC: FMOD.DSP_RESAMPLER;
	DSP_RESAMPLER_SPLINE: FMOD.DSP_RESAMPLER;
	DSP_RESAMPLER_MAX: FMOD.DSP_RESAMPLER;
	DSP_CALLBACK_DATAPARAMETERRELEASE: FMOD.DSP_CALLBACK;
	DSP_CALLBACK_MAX: FMOD.DSP_CALLBACK;
	DSPCONNECTION_TYPE_STANDARD: FMOD.DSPCONNECTION_TYPE;
	DSPCONNECTION_TYPE_SIDECHAIN: FMOD.DSPCONNECTION_TYPE;
	DSPCONNECTION_TYPE_SEND: FMOD.DSPCONNECTION_TYPE;
	DSPCONNECTION_TYPE_SEND_SIDECHAIN: FMOD.DSPCONNECTION_TYPE;
	DSPCONNECTION_TYPE_MAX: FMOD.DSPCONNECTION_TYPE;
	TAGTYPE_UNKNOWN: FMOD.TAGTYPE;
	TAGTYPE_ID3V1: FMOD.TAGTYPE;
	TAGTYPE_ID3V2: FMOD.TAGTYPE;
	TAGTYPE_VORBISCOMMENT: FMOD.TAGTYPE;
	TAGTYPE_SHOUTCAST: FMOD.TAGTYPE;
	TAGTYPE_ICECAST: FMOD.TAGTYPE;
	TAGTYPE_ASF: FMOD.TAGTYPE;
	TAGTYPE_MIDI: FMOD.TAGTYPE;
	TAGTYPE_PLAYLIST: FMOD.TAGTYPE;
	TAGTYPE_FMOD: FMOD.TAGTYPE;
	TAGTYPE_USER: FMOD.TAGTYPE;
	TAGTYPE_MAX: FMOD.TAGTYPE;
	TAGDATATYPE_BINARY: FMOD.TAGDATATYPE;
	TAGDATATYPE_INT: FMOD.TAGDATATYPE;
	TAGDATATYPE_FLOAT: FMOD.TAGDATATYPE;
	TAGDATATYPE_STRING: FMOD.TAGDATATYPE;
	TAGDATATYPE_STRING_UTF16: FMOD.TAGDATATYPE;
	TAGDATATYPE_STRING_UTF16BE: FMOD.TAGDATATYPE;
	TAGDATATYPE_STRING_UTF8: FMOD.TAGDATATYPE;
	TAGDATATYPE_MAX: FMOD.TAGDATATYPE;
	PORT_TYPE_MUSIC: FMOD.PORT_TYPE;
	PORT_TYPE_COPYRIGHT_MUSIC: FMOD.PORT_TYPE;
	PORT_TYPE_VOICE: FMOD.PORT_TYPE;
	PORT_TYPE_CONTROLLER: FMOD.PORT_TYPE;
	PORT_TYPE_PERSONAL: FMOD.PORT_TYPE;
	PORT_TYPE_VIBRATION: FMOD.PORT_TYPE;
	PORT_TYPE_AUX: FMOD.PORT_TYPE;
	PORT_TYPE_MAX: FMOD.PORT_TYPE;
	DSP_PROCESS_PERFORM: FMOD.DSP_PROCESS_OPERATION;
	DSP_PROCESS_QUERY: FMOD.DSP_PROCESS_OPERATION;
	DSP_PAN_SURROUND_DEFAULT: FMOD.DSP_PAN;
	DSP_PAN_SURROUND_ROTATION_NOT_BIASED: FMOD.DSP_PAN;
	DSP_PARAMETER_TYPE_FLOAT: FMOD.DSP_PARAMETER_TYPE;
	DSP_PARAMETER_TYPE_INT: FMOD.DSP_PARAMETER_TYPE;
	DSP_PARAMETER_TYPE_BOOL: FMOD.DSP_PARAMETER_TYPE;
	DSP_PARAMETER_TYPE_DATA: FMOD.DSP_PARAMETER_TYPE;
	DSP_PARAMETER_TYPE_MAX: FMOD.DSP_PARAMETER_TYPE;
	DSP_PARAMETER_FLOAT_MAPPING_TYPE_LINEAR: FMOD.DSP_PARAMETER_FLOAT_MAPPING_TYPE;
	DSP_PARAMETER_FLOAT_MAPPING_TYPE_AUTO: FMOD.DSP_PARAMETER_FLOAT_MAPPING_TYPE;
	DSP_PARAMETER_FLOAT_MAPPING_TYPE_PIECEWISE_LINEAR: FMOD.DSP_PARAMETER_FLOAT_MAPPING_TYPE;
	DSP_PARAMETER_DATA_TYPE_USER: FMOD.DSP_PARAMETER_DATA_TYPE;
	DSP_PARAMETER_DATA_TYPE_OVERALLGAIN: FMOD.DSP_PARAMETER_DATA_TYPE;
	DSP_PARAMETER_DATA_TYPE_3DATTRIBUTES: FMOD.DSP_PARAMETER_DATA_TYPE;
	DSP_PARAMETER_DATA_TYPE_SIDECHAIN: FMOD.DSP_PARAMETER_DATA_TYPE;
	DSP_PARAMETER_DATA_TYPE_FFT: FMOD.DSP_PARAMETER_DATA_TYPE;
	DSP_PARAMETER_DATA_TYPE_3DATTRIBUTES_MULTI: FMOD.DSP_PARAMETER_DATA_TYPE;
	DSP_PARAMETER_DATA_TYPE_ATTENUATION_RANGE: FMOD.DSP_PARAMETER_DATA_TYPE;
	DSP_TYPE_UNKNOWN: FMOD.DSP_TYPE;
	DSP_TYPE_MIXER: FMOD.DSP_TYPE;
	DSP_TYPE_OSCILLATOR: FMOD.DSP_TYPE;
	DSP_TYPE_LOWPASS: FMOD.DSP_TYPE;
	DSP_TYPE_ITLOWPASS: FMOD.DSP_TYPE;
	DSP_TYPE_HIGHPASS: FMOD.DSP_TYPE;
	DSP_TYPE_ECHO: FMOD.DSP_TYPE;
	DSP_TYPE_FADER: FMOD.DSP_TYPE;
	DSP_TYPE_FLANGE: FMOD.DSP_TYPE;
	DSP_TYPE_DISTORTION: FMOD.DSP_TYPE;
	DSP_TYPE_NORMALIZE: FMOD.DSP_TYPE;
	DSP_TYPE_LIMITER: FMOD.DSP_TYPE;
	DSP_TYPE_PARAMEQ: FMOD.DSP_TYPE;
	DSP_TYPE_PITCHSHIFT: FMOD.DSP_TYPE;
	DSP_TYPE_CHORUS: FMOD.DSP_TYPE;
	DSP_TYPE_VSTPLUGIN: FMOD.DSP_TYPE;
	DSP_TYPE_WINAMPPLUGIN: FMOD.DSP_TYPE;
	DSP_TYPE_ITECHO: FMOD.DSP_TYPE;
	DSP_TYPE_COMPRESSOR: FMOD.DSP_TYPE;
	DSP_TYPE_SFXREVERB: FMOD.DSP_TYPE;
	DSP_TYPE_LOWPASS_SIMPLE: FMOD.DSP_TYPE;
	DSP_TYPE_DELAY: FMOD.DSP_TYPE;
	DSP_TYPE_TREMOLO: FMOD.DSP_TYPE;
	DSP_TYPE_LADSPAPLUGIN: FMOD.DSP_TYPE;
	DSP_TYPE_SEND: FMOD.DSP_TYPE;
	DSP_TYPE_RETURN: FMOD.DSP_TYPE;
	DSP_TYPE_HIGHPASS_SIMPLE: FMOD.DSP_TYPE;
	DSP_TYPE_PAN: FMOD.DSP_TYPE;
	DSP_TYPE_THREE_EQ: FMOD.DSP_TYPE;
	DSP_TYPE_FFT: FMOD.DSP_TYPE;
	DSP_TYPE_LOUDNESS_METER: FMOD.DSP_TYPE;
	DSP_TYPE_ENVELOPEFOLLOWER: FMOD.DSP_TYPE;
	DSP_TYPE_CONVOLUTIONREVERB: FMOD.DSP_TYPE;
	DSP_TYPE_CHANNELMIX: FMOD.DSP_TYPE;
	DSP_TYPE_TRANSCEIVER: FMOD.DSP_TYPE;
	DSP_TYPE_OBJECTPAN: FMOD.DSP_TYPE;
	DSP_TYPE_MULTIBAND_EQ: FMOD.DSP_TYPE;
	DSP_TYPE_MAX: FMOD.DSP_TYPE;
	DSP_OSCILLATOR_TYPE: FMOD.DSP_OSCILLATOR;
	DSP_OSCILLATOR_RATE: FMOD.DSP_OSCILLATOR;
	DSP_LOWPASS_CUTOFF: FMOD.DSP_LOWPASS;
	DSP_LOWPASS_RESONANCE: FMOD.DSP_LOWPASS;
	DSP_ITLOWPASS_CUTOFF: FMOD.DSP_ITLOWPASS;
	DSP_ITLOWPASS_RESONANCE: FMOD.DSP_ITLOWPASS;
	DSP_HIGHPASS_CUTOFF: FMOD.DSP_HIGHPASS;
	DSP_HIGHPASS_RESONANCE: FMOD.DSP_HIGHPASS;
	DSP_ECHO_DELAY: FMOD.DSP_ECHO;
	DSP_ECHO_FEEDBACK: FMOD.DSP_ECHO;
	DSP_ECHO_DRYLEVEL: FMOD.DSP_ECHO;
	DSP_ECHO_WETLEVEL: FMOD.DSP_ECHO;
	DSP_FLANGE_MIX: FMOD.DSP_FLANGE;
	DSP_FLANGE_DEPTH: FMOD.DSP_FLANGE;
	DSP_FLANGE_RATE: FMOD.DSP_FLANGE;
	DSP_DISTORTION_LEVEL: FMOD.DSP_DISTORTION;
	DSP_NORMALIZE_FADETIME: FMOD.DSP_NORMALIZE;
	DSP_NORMALIZE_THRESHOLD: FMOD.DSP_NORMALIZE;
	DSP_NORMALIZE_MAXAMP: FMOD.DSP_NORMALIZE;
	DSP_LIMITER_RELEASETIME: FMOD.DSP_LIMITER;
	DSP_LIMITER_CEILING: FMOD.DSP_LIMITER;
	DSP_LIMITER_MAXIMIZERGAIN: FMOD.DSP_LIMITER;
	DSP_LIMITER_MODE: FMOD.DSP_LIMITER;
	DSP_PARAMEQ_CENTER: FMOD.DSP_PARAMEQ;
	DSP_PARAMEQ_BANDWIDTH: FMOD.DSP_PARAMEQ;
	DSP_PARAMEQ_GAIN: FMOD.DSP_PARAMEQ;
	DSP_MULTIBAND_EQ_A_FILTER: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_A_FREQUENCY: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_A_Q: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_A_GAIN: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_B_FILTER: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_B_FREQUENCY: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_B_Q: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_B_GAIN: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_C_FILTER: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_C_FREQUENCY: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_C_Q: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_C_GAIN: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_D_FILTER: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_D_FREQUENCY: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_D_Q: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_D_GAIN: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_E_FILTER: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_E_FREQUENCY: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_E_Q: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_E_GAIN: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_DISABLED: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_LOWPASS_12DB: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_LOWPASS_24DB: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_LOWPASS_48DB: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_HIGHPASS_12DB: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_HIGHPASS_24DB: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_HIGHPASS_48DB: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_LOWSHELF: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_HIGHSHELF: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_PEAKING: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_BANDPASS: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_NOTCH: FMOD.DSP_MULTIBAND_EQ;
	DSP_MULTIBAND_EQ_FILTER_ALLPASS: FMOD.DSP_MULTIBAND_EQ;
	DSP_PITCHSHIFT_PITCH: FMOD.DSP_PITCHSHIFT;
	DSP_PITCHSHIFT_FFTSIZE: FMOD.DSP_PITCHSHIFT;
	DSP_PITCHSHIFT_OVERLAP: FMOD.DSP_PITCHSHIFT;
	DSP_PITCHSHIFT_MAXCHANNELS: FMOD.DSP_PITCHSHIFT;
	DSP_CHORUS_MIX: FMOD.DSP_CHORUS;
	DSP_CHORUS_RATE: FMOD.DSP_CHORUS;
	DSP_CHORUS_DEPTH: FMOD.DSP_CHORUS;
	DSP_ITECHO_WETDRYMIX: FMOD.DSP_ITECHO;
	DSP_ITECHO_FEEDBACK: FMOD.DSP_ITECHO;
	DSP_ITECHO_LEFTDELAY: FMOD.DSP_ITECHO;
	DSP_ITECHO_RIGHTDELAY: FMOD.DSP_ITECHO;
	DSP_ITECHO_PANDELAY: FMOD.DSP_ITECHO;
	DSP_COMPRESSOR_THRESHOLD: FMOD.DSP_COMPRESSOR;
	DSP_COMPRESSOR_RATIO: FMOD.DSP_COMPRESSOR;
	DSP_COMPRESSOR_ATTACK: FMOD.DSP_COMPRESSOR;
	DSP_COMPRESSOR_RELEASE: FMOD.DSP_COMPRESSOR;
	DSP_COMPRESSOR_GAINMAKEUP: FMOD.DSP_COMPRESSOR;
	DSP_COMPRESSOR_USESIDECHAIN: FMOD.DSP_COMPRESSOR;
	DSP_COMPRESSOR_LINKED: FMOD.DSP_COMPRESSOR;
	DSP_SFXREVERB_DECAYTIME: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_EARLYDELAY: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_LATEDELAY: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_HFREFERENCE: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_HFDECAYRATIO: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_DIFFUSION: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_DENSITY: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_LOWSHELFFREQUENCY: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_LOWSHELFGAIN: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_HIGHCUT: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_EARLYLATEMIX: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_WETLEVEL: FMOD.DSP_SFXREVERB;
	DSP_SFXREVERB_DRYLEVEL: FMOD.DSP_SFXREVERB;
	DSP_LOWPASS_SIMPLE_CUTOFF: FMOD.DSP_LOWPASS_SIMPLE;
	DSP_DELAY_CH0: FMOD.DSP_DELAY;
	DSP_DELAY_CH1: FMOD.DSP_DELAY;
	DSP_DELAY_CH2: FMOD.DSP_DELAY;
	DSP_DELAY_CH3: FMOD.DSP_DELAY;
	DSP_DELAY_CH4: FMOD.DSP_DELAY;
	DSP_DELAY_CH5: FMOD.DSP_DELAY;
	DSP_DELAY_CH6: FMOD.DSP_DELAY;
	DSP_DELAY_CH7: FMOD.DSP_DELAY;
	DSP_DELAY_CH8: FMOD.DSP_DELAY;
	DSP_DELAY_CH9: FMOD.DSP_DELAY;
	DSP_DELAY_CH10: FMOD.DSP_DELAY;
	DSP_DELAY_CH11: FMOD.DSP_DELAY;
	DSP_DELAY_CH12: FMOD.DSP_DELAY;
	DSP_DELAY_CH13: FMOD.DSP_DELAY;
	DSP_DELAY_CH14: FMOD.DSP_DELAY;
	DSP_DELAY_CH15: FMOD.DSP_DELAY;
	DSP_DELAY_MAXDELAY: FMOD.DSP_DELAY;
	DSP_TREMOLO_FREQUENCY: FMOD.DSP_TREMOLO;
	DSP_TREMOLO_DEPTH: FMOD.DSP_TREMOLO;
	DSP_TREMOLO_SHAPE: FMOD.DSP_TREMOLO;
	DSP_TREMOLO_SKEW: FMOD.DSP_TREMOLO;
	DSP_TREMOLO_DUTY: FMOD.DSP_TREMOLO;
	DSP_TREMOLO_SQUARE: FMOD.DSP_TREMOLO;
	DSP_TREMOLO_PHASE: FMOD.DSP_TREMOLO;
	DSP_TREMOLO_SPREAD: FMOD.DSP_TREMOLO;
	DSP_SEND_RETURNID: FMOD.DSP_SEND;
	DSP_SEND_LEVEL: FMOD.DSP_SEND;
	DSP_RETURN_ID: FMOD.DSP_RETURN;
	DSP_RETURN_INPUT_SPEAKER_MODE: FMOD.DSP_RETURN;
	DSP_HIGHPASS_SIMPLE_CUTOFF: FMOD.DSP_HIGHPASS_SIMPLE;
	DSP_PAN_2D_STEREO_MODE_DISTRIBUTED: FMOD.DSP_PAN_2D_STEREO_MODE_TYPE;
	DSP_PAN_2D_STEREO_MODE_DISCRETE: FMOD.DSP_PAN_2D_STEREO_MODE_TYPE;
	DSP_PAN_MODE_MONO: FMOD.DSP_PAN;
	DSP_PAN_MODE_STEREO: FMOD.DSP_PAN;
	DSP_PAN_MODE_SURROUND: FMOD.DSP_PAN;
	DSP_PAN_3D_ROLLOFF_LINEARSQUARED: FMOD.DSP_PAN_3D_ROLLOFF_TYPE;
	DSP_PAN_3D_ROLLOFF_LINEAR: FMOD.DSP_PAN_3D_ROLLOFF_TYPE;
	DSP_PAN_3D_ROLLOFF_INVERSE: FMOD.DSP_PAN_3D_ROLLOFF_TYPE;
	DSP_PAN_3D_ROLLOFF_INVERSETAPERED: FMOD.DSP_PAN_3D_ROLLOFF_TYPE;
	DSP_PAN_3D_ROLLOFF_CUSTOM: FMOD.DSP_PAN_3D_ROLLOFF_TYPE;
	DSP_PAN_3D_EXTENT_MODE_AUTO: FMOD.DSP_PAN_3D_EXTENT_MODE_TYPE;
	DSP_PAN_3D_EXTENT_MODE_USER: FMOD.DSP_PAN_3D_EXTENT_MODE_TYPE;
	DSP_PAN_3D_EXTENT_MODE_OFF: FMOD.DSP_PAN_3D_EXTENT_MODE_TYPE;
	DSP_PAN_MODE: FMOD.DSP_PAN;
	DSP_PAN_2D_STEREO_POSITION: FMOD.DSP_PAN_2D_STEREO_MODE_TYPE;
	DSP_PAN_2D_DIRECTION: FMOD.DSP_PAN;
	DSP_PAN_2D_EXTENT: FMOD.DSP_PAN;
	DSP_PAN_2D_ROTATION: FMOD.DSP_PAN;
	DSP_PAN_2D_LFE_LEVEL: FMOD.DSP_PAN;
	DSP_PAN_2D_STEREO_MODE: FMOD.DSP_PAN;
	DSP_PAN_2D_STEREO_SEPARATION: FMOD.DSP_PAN;
	DSP_PAN_2D_STEREO_AXIS: FMOD.DSP_PAN;
	DSP_PAN_ENABLED_SPEAKERS: FMOD.DSP_PAN;
	DSP_PAN_3D_POSITION: FMOD.DSP_PAN;
	DSP_PAN_3D_ROLLOFF: FMOD.DSP_PAN;
	DSP_PAN_3D_MIN_DISTANCE: FMOD.DSP_PAN;
	DSP_PAN_3D_MAX_DISTANCE: FMOD.DSP_PAN;
	DSP_PAN_3D_EXTENT_MODE: FMOD.DSP_PAN;
	DSP_PAN_3D_SOUND_SIZE: FMOD.DSP_PAN;
	DSP_PAN_3D_MIN_EXTENT: FMOD.DSP_PAN;
	DSP_PAN_3D_PAN_BLEND: FMOD.DSP_PAN;
	DSP_PAN_LFE_UPMIX_ENABLED: FMOD.DSP_PAN;
	DSP_PAN_OVERALL_GAIN: FMOD.DSP_PAN;
	DSP_PAN_SURROUND_SPEAKER_MODE: FMOD.SPEAKER;
	DSP_PAN_2D_HEIGHT_BLEND: FMOD.DSP_PAN._2D_HEIGHT_BLEND; // add
	DSP_PAN_ATTENUATION_RANGE: FMOD.DSP_PAN; // add
	DSP_PAN_OVERRIDE_RANGE: FMOD.DSP_PAN; // add
	DSP_THREE_EQ_CROSSOVERSLOPE_12DB: FMOD.DSP_THREE_EQ;
	DSP_THREE_EQ_CROSSOVERSLOPE_24DB: FMOD.DSP_THREE_EQ;
	DSP_THREE_EQ_CROSSOVERSLOPE_48DB: FMOD.DSP_THREE_EQ;
	DSP_THREE_EQ_LOWGAIN: FMOD.DSP_THREE_EQ;
	DSP_THREE_EQ_MIDGAIN: FMOD.DSP_THREE_EQ;
	DSP_THREE_EQ_HIGHGAIN: FMOD.DSP_THREE_EQ;
	DSP_THREE_EQ_LOWCROSSOVER: FMOD.DSP_THREE_EQ;
	DSP_THREE_EQ_HIGHCROSSOVER: FMOD.DSP_THREE_EQ;
	DSP_THREE_EQ_CROSSOVERSLOPE: FMOD.DSP_THREE_EQ;
	DSP_FFT_WINDOW_RECT: FMOD.DSP_FFT_WINDOW;
	DSP_FFT_WINDOW_TRIANGLE: FMOD.DSP_FFT_WINDOW;
	DSP_FFT_WINDOW_HAMMING: FMOD.DSP_FFT_WINDOW;
	DSP_FFT_WINDOW_HANNING: FMOD.DSP_FFT_WINDOW;
	DSP_FFT_WINDOW_BLACKMAN: FMOD.DSP_FFT_WINDOW;
	DSP_FFT_WINDOW_BLACKMANHARRIS: FMOD.DSP_FFT_WINDOW;
	DSP_FFT_WINDOWSIZE: FMOD.DSP_FFT;
	DSP_FFT_WINDOWTYPE: FMOD.DSP_FFT;
	DSP_FFT_SPECTRUMDATA: FMOD.DSP_FFT;
	DSP_FFT_DOMINANT_FREQ: FMOD.DSP_FFT;
	DSP_ENVELOPEFOLLOWER_ATTACK: FMOD.DSP_ENVELOPEFOLLOWER;
	DSP_ENVELOPEFOLLOWER_RELEASE: FMOD.DSP_ENVELOPEFOLLOWER;
	DSP_ENVELOPEFOLLOWER_ENVELOPE: FMOD.DSP_ENVELOPEFOLLOWER;
	DSP_ENVELOPEFOLLOWER_USESIDECHAIN: FMOD.DSP_ENVELOPEFOLLOWER;
	DSP_CONVOLUTION_REVERB_PARAM_IR: FMOD.DSP_CONVOLUTION_REVERB;
	DSP_CONVOLUTION_REVERB_PARAM_WET: FMOD.DSP_CONVOLUTION_REVERB;
	DSP_CONVOLUTION_REVERB_PARAM_DRY: FMOD.DSP_CONVOLUTION_REVERB;
	DSP_CONVOLUTION_REVERB_PARAM_LINKED: FMOD.DSP_CONVOLUTION_REVERB;
	DSP_CHANNELMIX_OUTPUT_DEFAULT: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_ALLMONO: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_ALLSTEREO: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_ALLQUAD: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_ALL5POINT1: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_ALL7POINT1: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_ALLLFE: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_ALL7POINT1POINT4: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUTGROUPING: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH0: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH1: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH2: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH3: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH4: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH5: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH6: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH7: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH8: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH9: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH10: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH11: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH12: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH13: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH14: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH15: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH16: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH17: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH18: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH19: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH20: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH21: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH22: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH23: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH24: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH25: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH26: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH27: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH28: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH29: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH30: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_GAIN_CH31: FMOD.DSP_CHANNELMIX;
	DSP_CHANNELMIX_OUTPUT_CH0: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH1: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH2: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH3: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH4: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH5: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH6: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH7: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH8: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH9: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH10: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH11: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH12: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH13: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH14: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH15: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH16: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH17: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH18: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH19: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH20: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH21: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH22: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH23: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH24: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH25: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH26: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH27: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH28: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH29: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH30: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_CHANNELMIX_OUTPUT_CH31: FMOD.DSP_CHANNELMIX_OUTPUT;
	DSP_TRANSCEIVER_SPEAKERMODE_AUTO: FMOD.DSP_TRANSCEIVER_SPEAKERMODE;
	DSP_TRANSCEIVER_SPEAKERMODE_MONO: FMOD.DSP_TRANSCEIVER_SPEAKERMODE;
	DSP_TRANSCEIVER_SPEAKERMODE_STEREO: FMOD.DSP_TRANSCEIVER_SPEAKERMODE;
	DSP_TRANSCEIVER_SPEAKERMODE_SURROUND: FMOD.DSP_TRANSCEIVER_SPEAKERMODE;
	DSP_TRANSCEIVER_TRANSMIT: FMOD.DSP_TRANSCEIVER;
	DSP_TRANSCEIVER_GAIN: FMOD.DSP_TRANSCEIVER;
	DSP_TRANSCEIVER_CHANNEL: FMOD.DSP_TRANSCEIVER;
	DSP_TRANSCEIVER_TRANSMITSPEAKERMODE: FMOD.DSP_TRANSCEIVER;
	DSP_OBJECTPAN_3D_POSITION: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_3D_ROLLOFF: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_3D_MIN_DISTANCE: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_3D_MAX_DISTANCE: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_3D_EXTENT_MODE: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_3D_SOUND_SIZE: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_3D_MIN_EXTENT: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_OVERALL_GAIN: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_OUTPUTGAIN: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_ATTENUATION_RANGE: FMOD.DSP_OBJECTPAN;
	DSP_OBJECTPAN_OVERRIDE_RANGE: FMOD.DSP_OBJECTPAN;
	DEBUG_LEVEL_NONE: FMOD.DEBUG_FLAGS;
	DEBUG_LEVEL_ERROR: FMOD.DEBUG_FLAGS;
	DEBUG_LEVEL_WARNING: FMOD.DEBUG_FLAGS;
	DEBUG_LEVEL_LOG: FMOD.DEBUG_FLAGS;
	DEBUG_TYPE_MEMORY: FMOD.DEBUG_FLAGS;
	DEBUG_TYPE_FILE: FMOD.DEBUG_FLAGS;
	DEBUG_TYPE_CODEC: FMOD.DEBUG_FLAGS;
	DEBUG_TYPE_TRACE: FMOD.DEBUG_FLAGS;
	DEBUG_DISPLAY_TIMESTAMPS: FMOD.DEBUG_FLAGS;
	DEBUG_DISPLAY_LINENUMBERS: FMOD.DEBUG_FLAGS;
	DEBUG_DISPLAY_THREAD: FMOD.DEBUG_FLAGS;
	MEMORY_NORMAL: FMOD.MEMORY_TYPE;
	MEMORY_STREAM_FILE: FMOD.MEMORY_TYPE;
	MEMORY_STREAM_DECODE: FMOD.MEMORY_TYPE;
	MEMORY_SAMPLEDATA: FMOD.MEMORY_TYPE;
	MEMORY_DSP_BUFFER: FMOD.MEMORY_TYPE;
	MEMORY_PLUGIN: FMOD.MEMORY_TYPE;
	MEMORY_PERSISTENT: FMOD.MEMORY_TYPE;
	MEMORY_SECONDARY: FMOD.MEMORY_TYPE;
	MAX_CHANNEL_WIDTH: number;
	MAX_LISTENERS: number;
	CHANNELMASK_FRONT_LEFT: FMOD.CHANNELMASK;
	CHANNELMASK_FRONT_RIGHT: FMOD.CHANNELMASK;
	CHANNELMASK_FRONT_CENTER: FMOD.CHANNELMASK;
	CHANNELMASK_LOW_FREQUENCY: FMOD.CHANNELMASK;
	CHANNELMASK_SURROUND_LEFT: FMOD.CHANNELMASK;
	CHANNELMASK_SURROUND_RIGHT: FMOD.CHANNELMASK;
	CHANNELMASK_BACK_LEFT: FMOD.CHANNELMASK;
	CHANNELMASK_BACK_RIGHT: FMOD.CHANNELMASK;
	CHANNELMASK_BACK_CENTER: FMOD.CHANNELMASK;
	CHANNELMASK_MONO: FMOD.CHANNELMASK;
	CHANNELMASK_STEREO: FMOD.CHANNELMASK;
	CHANNELMASK_LRC: FMOD.CHANNELMASK;
	CHANNELMASK_QUAD: FMOD.CHANNELMASK;
	CHANNELMASK_SURROUND: FMOD.CHANNELMASK;
	CHANNELMASK_5POINT1: FMOD.CHANNELMASK;
	CHANNELMASK_5POINT1_REARS: FMOD.CHANNELMASK;
	CHANNELMASK_7POINT0: FMOD.CHANNELMASK;
	CHANNELMASK_7POINT1: FMOD.CHANNELMASK;
	INIT_NORMAL: FMOD.INITFLAGS;
	INIT_STREAM_FROM_UPDATE: FMOD.INITFLAGS;
	INIT_MIX_FROM_UPDATE: FMOD.INITFLAGS;
	INIT_3D_RIGHTHANDED: FMOD.INITFLAGS;
	INIT_CLIP_OUTPUT: FMOD.INITFLAGS;
	INIT_CHANNEL_LOWPASS: FMOD.INITFLAGS;
	INIT_CHANNEL_DISTANCEFILTER: FMOD.INITFLAGS;
	INIT_PROFILE_ENABLE: FMOD.INITFLAGS;
	INIT_VOL0_BECOMES_VIRTUAL: FMOD.INITFLAGS;
	INIT_GEOMETRY_USECLOSEST: FMOD.INITFLAGS;
	INIT_PREFER_DOLBY_DOWNMIX: FMOD.INITFLAGS;
	INIT_THREAD_UNSAFE: FMOD.INITFLAGS;
	INIT_PROFILE_METER_ALL: FMOD.INITFLAGS;
	INIT_MEMORY_TRACKING: FMOD.INITFLAGS;
	DEFAULT: FMOD.MODE;
	LOOP_OFF: FMOD.MODE;
	LOOP_NORMAL: FMOD.MODE;
	LOOP_BIDI: FMOD.MODE;
	_2D: FMOD.MODE;
	_3D: FMOD.MODE;
	CREATESTREAM: FMOD.MODE;
	CREATESAMPLE: FMOD.MODE;
	CREATECOMPRESSEDSAMPLE: FMOD.MODE;
	OPENUSER: FMOD.MODE;
	OPENMEMORY: FMOD.MODE;
	OPENMEMORY_POINT: FMOD.MODE;
	OPENRAW: FMOD.MODE;
	OPENONLY: FMOD.MODE;
	ACCURATETIME: FMOD.MODE;
	MPEGSEARCH: FMOD.MODE;
	NONBLOCKING: FMOD.MODE;
	UNIQUE: FMOD.MODE;
	_3D_HEADRELATIVE: FMOD.MODE;
	_3D_WORLDRELATIVE: FMOD.MODE;
	_3D_INVERSEROLLOFF: FMOD.MODE;
	_3D_LINEARROLLOFF: FMOD.MODE;
	_3D_LINEARSQUAREROLLOFF: FMOD.MODE;
	_3D_INVERSETAPEREDROLLOFF: FMOD.MODE;
	_3D_CUSTOMROLLOFF: FMOD.MODE;
	_3D_IGNOREGEOMETRY: FMOD.MODE;
	IGNORETAGS: FMOD.MODE;
	LOWMEM: FMOD.MODE;
	SYSTEM_CALLBACK_DEVICELISTCHANGED: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_DEVICELOST: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_MEMORYALLOCATIONFAILED: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_THREADCREATED: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_BADDSPCONNECTION: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_PREMIX: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_POSTMIX: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_ERROR: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_MIDMIX: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_THREADDESTROYED: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_PREUPDATE: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_POSTUPDATE: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_RECORDLISTCHANGED: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_BUFFEREDNOMIX: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_DEVICEREINITIALIZE: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_OUTPUTUNDERRUN: FMOD.SYSTEM_CALLBACK_TYPE;
	SYSTEM_CALLBACK_RECORDPOSITIONCHANGED: FMOD.SYSTEM_CALLBACK_TYPE;
	TIMEUNIT_MS: FMOD.TIMEUNIT;
	TIMEUNIT_PCM: FMOD.TIMEUNIT;
	TIMEUNIT_PCMBYTES: FMOD.TIMEUNIT;
	TIMEUNIT_RAWBYTES: FMOD.TIMEUNIT;
	TIMEUNIT_PCMFRACTION: FMOD.TIMEUNIT;
	TIMEUNIT_MODORDER: FMOD.TIMEUNIT;
	TIMEUNIT_MODROW: FMOD.TIMEUNIT;
	TIMEUNIT_MODPATTERN: FMOD.TIMEUNIT;
	TIMEUNIT_BUFFERED: FMOD.TIMEUNIT;
	REVERB_MAXINSTANCES: number;
	DRIVER_STATE_CONNECTED: number;
	DRIVER_STATE_DEFAULT: number;
	CODEC_WAVEFORMAT_VERSION: number;
	DSP_GETPARAM_VALUESTR_LENGTH: number;
	STUDIO_LOADING_STATE_UNLOADING: FMOD.STUDIO_LOADING_STATE;
	STUDIO_LOADING_STATE_UNLOADED: FMOD.STUDIO_LOADING_STATE;
	STUDIO_LOADING_STATE_LOADING: FMOD.STUDIO_LOADING_STATE;
	STUDIO_LOADING_STATE_LOADED: FMOD.STUDIO_LOADING_STATE;
	STUDIO_LOADING_STATE_ERROR: FMOD.STUDIO_LOADING_STATE;
	STUDIO_LOAD_MEMORY: FMOD.STUDIO_LOAD_MEMORY_MODE;
	STUDIO_LOAD_MEMORY_POINT: FMOD.STUDIO_LOAD_MEMORY_MODE;
	STUDIO_PARAMETER_GAME_CONTROLLED: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_AUTOMATIC_DISTANCE: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_AUTOMATIC_EVENT_CONE_ANGLE: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_AUTOMATIC_EVENT_ORIENTATION: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_AUTOMATIC_DIRECTION: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_AUTOMATIC_ELEVATION: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_AUTOMATIC_LISTENER_ORIENTATION: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_AUTOMATIC_SPEED: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_AUTOMATIC_SPEED_ABSOLUTE: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_AUTOMATIC_DISTANCE_NORMALIZED: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_PARAMETER_MAX: FMOD.STUDIO_PARAMETER_TYPE;
	STUDIO_USER_PROPERTY_TYPE_INTEGER: FMOD.STUDIO_USER_PROPERTY_TYPE;
	STUDIO_USER_PROPERTY_TYPE_BOOLEAN: FMOD.STUDIO_USER_PROPERTY_TYPE;
	STUDIO_USER_PROPERTY_TYPE_FLOAT: FMOD.STUDIO_USER_PROPERTY_TYPE;
	STUDIO_USER_PROPERTY_TYPE_STRING: FMOD.STUDIO_USER_PROPERTY_TYPE;
	STUDIO_EVENT_PROPERTY_CHANNELPRIORITY: FMOD.STUDIO_EVENT_PROPERTY;
	STUDIO_EVENT_PROPERTY_SCHEDULE_DELAY: FMOD.STUDIO_EVENT_PROPERTY;
	STUDIO_EVENT_PROPERTY_SCHEDULE_LOOKAHEAD: FMOD.STUDIO_EVENT_PROPERTY;
	STUDIO_EVENT_PROPERTY_MINIMUM_DISTANCE: FMOD.STUDIO_EVENT_PROPERTY;
	STUDIO_EVENT_PROPERTY_MAXIMUM_DISTANCE: FMOD.STUDIO_EVENT_PROPERTY;
	STUDIO_EVENT_PROPERTY_COOLDOWN: FMOD.STUDIO_EVENT_PROPERTY;
	STUDIO_EVENT_PROPERTY_MAX: FMOD.STUDIO_EVENT_PROPERTY;
	STUDIO_PLAYBACK_PLAYING: FMOD.STUDIO_PLAYBACK_STATE;
	STUDIO_PLAYBACK_SUSTAINING: FMOD.STUDIO_PLAYBACK_STATE;
	STUDIO_PLAYBACK_STOPPED: FMOD.STUDIO_PLAYBACK_STATE;
	STUDIO_PLAYBACK_STARTING: FMOD.STUDIO_PLAYBACK_STATE;
	STUDIO_PLAYBACK_STOPPING: FMOD.STUDIO_PLAYBACK_STATE;
	STUDIO_STOP_ALLOWFADEOUT: FMOD.STUDIO_STOP_MODE;
	STUDIO_STOP_IMMEDIATE: FMOD.STUDIO_STOP_MODE;
	STUDIO_INSTANCETYPE_NONE: FMOD.STUDIO_INSTANCETYPE;
	STUDIO_INSTANCETYPE_SYSTEM: FMOD.STUDIO_INSTANCETYPE;
	STUDIO_INSTANCETYPE_EVENTDESCRIPTION: FMOD.STUDIO_INSTANCETYPE;
	STUDIO_INSTANCETYPE_EVENTINSTANCE: FMOD.STUDIO_INSTANCETYPE;
	STUDIO_INSTANCETYPE_PARAMETERINSTANCE: FMOD.STUDIO_INSTANCETYPE;
	STUDIO_INSTANCETYPE_BUS: FMOD.STUDIO_INSTANCETYPE;
	STUDIO_INSTANCETYPE_VCA: FMOD.STUDIO_INSTANCETYPE;
	STUDIO_INSTANCETYPE_BANK: FMOD.STUDIO_INSTANCETYPE;
	STUDIO_INSTANCETYPE_COMMANDREPLAY: FMOD.STUDIO_INSTANCETYPE;
	STUDIO_INIT_NORMAL: FMOD.STUDIO_INITFLAGS;
	STUDIO_INIT_LIVEUPDATE: FMOD.STUDIO_INITFLAGS;
	STUDIO_INIT_ALLOW_MISSING_PLUGINS: FMOD.STUDIO_INITFLAGS;
	STUDIO_INIT_SYNCHRONOUS_UPDATE: FMOD.STUDIO_INITFLAGS;
	STUDIO_INIT_DEFERRED_CALLBACKS: FMOD.STUDIO_INITFLAGS;
	STUDIO_INIT_LOAD_FROM_UPDATE: FMOD.STUDIO_INITFLAGS;
	STUDIO_INIT_MEMORY_TRACKING: FMOD.STUDIO_INITFLAGS;
	STUDIO_PARAMETER_READONLY: FMOD.STUDIO_PARAMETER_FLAGS;
	STUDIO_PARAMETER_AUTOMATIC: FMOD.STUDIO_PARAMETER_FLAGS;
	STUDIO_PARAMETER_GLOBAL: FMOD.STUDIO_PARAMETER_FLAGS;
	STUDIO_PARAMETER_DISCRETE: FMOD.STUDIO_PARAMETER_FLAGS;
	STUDIO_PARAMETER_LABELED: FMOD.STUDIO_PARAMETER_FLAGS;
	STUDIO_LOAD_MEMORY_ALIGNMENT: number;
	STUDIO_SYSTEM_CALLBACK_PREUPDATE: FMOD.STUDIO_SYSTEM_CALLBACK_TYPE;
	STUDIO_SYSTEM_CALLBACK_POSTUPDATE: FMOD.STUDIO_SYSTEM_CALLBACK_TYPE;
	STUDIO_SYSTEM_CALLBACK_BANK_UNLOAD: FMOD.STUDIO_SYSTEM_CALLBACK_TYPE;
	STUDIO_SYSTEM_CALLBACK_LIVEUPDATE_CONNECTED: FMOD.STUDIO_SYSTEM_CALLBACK_TYPE;
	STUDIO_SYSTEM_CALLBACK_LIVEUPDATE_DISCONNECTED: FMOD.STUDIO_SYSTEM_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_CREATED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_DESTROYED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_STARTING: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_STARTED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_RESTARTED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_STOPPED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_START_FAILED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_CREATE_PROGRAMMER_SOUND: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_DESTROY_PROGRAMMER_SOUND: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_PLUGIN_CREATED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_PLUGIN_DESTROYED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_TIMELINE_MARKER: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_TIMELINE_BEAT: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_SOUND_PLAYED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_SOUND_STOPPED: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_REAL_TO_VIRTUAL: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_VIRTUAL_TO_REAL: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_START_EVENT_COMMAND: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_NESTED_TIMELINE_BEAT: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	STUDIO_LOAD_BANK_NORMAL: FMOD.STUDIO_LOAD_BANK_FLAGS;
	STUDIO_LOAD_BANK_NONBLOCKING: FMOD.STUDIO_LOAD_BANK_FLAGS;
	STUDIO_LOAD_BANK_DECOMPRESS_SAMPLES: FMOD.STUDIO_LOAD_BANK_FLAGS;
	STUDIO_COMMANDCAPTURE_NORMAL: FMOD.STUDIO_COMMANDCAPTURE_FLAGS;
	STUDIO_COMMANDCAPTURE_FILEFLUSH: FMOD.STUDIO_COMMANDCAPTURE_FLAGS;
	STUDIO_COMMANDCAPTURE_SKIP_INITIAL_STATE: FMOD.STUDIO_COMMANDCAPTURE_FLAGS;
	STUDIO_COMMANDREPLAY_NORMAL: FMOD.STUDIO_COMMANDREPLAY_FLAGS;
	STUDIO_COMMANDREPLAY_SKIP_CLEANUP: FMOD.STUDIO_COMMANDREPLAY_FLAGS;
	STUDIO_COMMANDREPLAY_FAST_FORWARD: FMOD.STUDIO_COMMANDREPLAY_FLAGS;
	MEMORY_ALL: FMOD.MEMORY_TYPE;
	VIRTUAL_PLAYFROMSTART: number;
	SYSTEM_CALLBACK_ALL: FMOD.SYSTEM_CALLBACK_TYPE;
	STUDIO_SYSTEM_CALLBACK_ALL: FMOD.STUDIO_SYSTEM_CALLBACK_TYPE;
	STUDIO_EVENT_CALLBACK_ALL: FMOD.STUDIO_EVENT_CALLBACK_TYPE;
	mWorkletNode: null;
	mModulePolling: boolean;
	mModuleLoading: boolean;
	mStartInterval: number;
	mStopInterval: null;
	mSuspendInterval: null;
	mResumeInterval: null;
	mWorkletNodeConnected: boolean;
	mInputRegistered: boolean;
	mContext: {};
	mAddModuleRef: number;
	FMOD_JS_MixerSlowpathFunction: () => void;
	FMOD_JS_MixerFastpathFunction: () => void;
	mSpeakerChannelCount: number;
	mUrl: string;
	mOutputData: Float32Array;
	mSharedArrayBuffers: boolean;
	waitForAudioWorklet: (condition: any, callback: any) => void;
	OutputAudioWorklet_resumeAudio: () => void;

    // end stuff typescript spat out
     ...
     * Creates a default structure
     */
    STUDIO_TIMELINE_NESTED_BEAT_PROPERTIES?() : FMOD.STUDIO_TIMELINE_NESTED_BEAT_PROPERTIES;
    /**
     * Creates a default structure
     */
...
declare namespace FMOD { 
    ...
    export interface System {
        ...
        getOutput(output: Out<OUTPUTTYPE>): RESULT;
...
Also defines the number of channels in the unit that a read callback will process, and the output signal of the unit.
    ...
    export interface StudioSystem {
         ...
         * @param attenuationposition Position used for calculating attenuation.
         * @returns an integer value defined in the FMOD_RESULT enumeration
         */
        getListenerAttributes(listener:number, attributes:Out<_3D_ATTRIBUTES>, n:Out<VECTOR>): RESULT;
        /** 
         ...
         */
        getParameterDescriptionByID(id: STUDIO_PARAMETER_ID, parameter: STUDIO_PARAMETER_DESCRIPTION): RESULT;
        /**
         ...
         * @param name Parameter name.
         * @param labelindex Label index to retrieve.
         * @param label Buffer to receive the label.
         * @param size Size of the label buffer in bytes. Must be 0 if label is null.
         * @param retrieved Length of the label in bytes, including the terminating null character.
         */
        getParameterLabelByName(name:string, labelindex: number, label: Out<string>, size: number, retrieved: Out<number>): RESULT;
        /**
         ...
         * @param retrieved Length of the label in bytes, including the terminating null character.
         */
        getParameterLabelByID(id: STUDIO_PARAMETER_ID, labelindex: number, label: Out<string>, size: number, retrieved: Out<number>): RESULT;
        /**
         ...
         * @returns an integer value defined in the FMOD_RESULT enumeration
         */
        setListenerAttributes(listener:number, attributes:_3D_ATTRIBUTES, attenuationposition?:VECTOR): RESULT;
        /** 
         ...
         * @param id Parameter identifier
         * @param label Value for given identifier
         * @param ignoreseekspeed Specifies whether to ignore the parameter's seek speed
         * and set the value immediately. (default: false)
         */
        setParameterByIDWithLabel(id: STUDIO_PARAMETER_ID, label: string, ignoreseekspeed?: boolean): RESULT;
        /**
         * Sets a global parameter value by unique identifier.
         * If any ID is set to all zeroes then the corresponding value will be ignored.
         ...
         * @param name Parameter name (case-insensitive).
         * @param label Labeled value for given name.
         * @param ignoreseekspeed Specifies whether to ignore the parameter's seek speed
         * and set the value immediately. (default: false)
         */
        setParameterByNameWithLabel(name:string, label:string, ignoreseekspeed?:boolean): RESULT;
        /** 
    ...
    export interface EventDescription {
         ...
         * @param retrieved Length of the label in bytes, including the terminating null character.
         */
        getParameterLabelByIndex(index: number, labelindex: number, label: Out<string>, size: number, retrieved: Out<number>): RESULT;
...
// #endregion LOW LEVEL SYSTEM STRUCTURES
    ...
    export const enum DSP_CALLBACK {
     ...
     * @deprecated */
    export const enum DSP_ENVELOPEFOLLOWER {
        ATTACK,
        RELEASE,
        ENVELOPE,
        USESIDECHAIN         
...
// #endregion LOW LEVEL SYSTEM ENUMERATIONS
    ...
    export interface STUDIO_TIMELINE_NESTED_BEAT_PROPERTIES {
        /** Event description GUID. */
        eventid:GUID;
        /** Beat properties. */
        properties:STUDIO_TIMELINE_BEAT_PROPERTIES;
    }
